...
namespace ObjCRuntime {
	...
	static partial class Trampolines {
		...
		[UserDelegateType (typeof (global::System.Action<bool, NSData>))]
		...
		static internal class SDActionArity2V0 {
			...
			static unsafe void Invoke (IntPtr block, bool arg1, IntPtr arg2) {
				...
				var del = (global::System.Action<bool, NSData>) (descriptor->Target);
				if (del != null)
					del (arg1,  Runtime.GetNSObject<NSData> (arg2));
			}
		...
		internal class NIDActionArity2V0 {
			...
			[Preserve (Conditional=true)]
			public unsafe static global::System.Action<bool, NSData> Create (IntPtr block)
			{
				if (block == IntPtr.Zero)
					return null;
				if (BlockLiteral.IsManagedBlock (block)) {
					var existing_delegate = ((BlockLiteral *) block)->Target as global::System.Action<bool, NSData>;
			...
			[Preserve (Conditional=true)]
			unsafe void Invoke (bool arg1, NSData arg2)
			{
